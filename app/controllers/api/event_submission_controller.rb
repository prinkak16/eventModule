class Api::EventSubmissionController < Api::ApplicationController
  ...
  def redirect_to_form
    ...
    data = { eventId: event.id, formId: "6F59CAC47E5AD7D5E5B8CA41E9173", submissionId: submission_id, eventName: event.name, eventStartDate: event.start_date, isFormCreator: false, eventEndDate: event.end_date, user: { name: current_user.name }, dataLevel: event.data_level&.name, eventStateIds: event.event_locations.pluck(:state_id) }
